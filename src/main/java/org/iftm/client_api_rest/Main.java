...
public class Main {
    public static void main(String[] args) {
        Client client1 = new Client(1L, "Alice", "123.456.789-00", 5000.0, Instant.parse("1990-01-01T00:00:00Z"), 2);
        Client client2 = new Client(2L, "Bob", "987.654.321-00", 7000.0, Instant.parse("1985-05-15T00:00:00Z"), 3);
